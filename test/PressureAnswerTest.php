...
class PressureAnswerTest extends PHPUnit_Framework_TestCase
{
    public function test_no_rounding_pressure_and_holding_steady() {
        ...
        $this->assertSame(
            '<speak>The pressure is 1005 millibars and is holding steady.</speak>',
            $testee->generate());
    }
    ...
    public function test_round_pressure_up_and_trending_up() {
        ...
        $this->assertSame(
            '<speak>The pressure is 1006 millibars and is trending up.</speak>',
            $testee->generate());
    }
    ...
    public function test_round_pressure_down_and_trending_down() {
        ...
        $this->assertSame(
            '<speak>The pressure is 1005 millibars and is trending down.</speak>',
            $testee->generate());
    }
